...
% 3. QUESTION BOX - For exercises, pairs with solution box
...
\newtcolorbox{questionbox}{
  ...
  top=12pt,
  bottom=12pt,
  before upper={\refstepcounter{questioncount}\textbf{Question \thequestioncount}\par\vspace{6pt}}
}

% 4. SOLUTION BOX - Teal header bar, light gray body, teal left border
