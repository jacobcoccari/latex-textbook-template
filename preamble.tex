...
% Plain style (used for chapter opening pages)
\fancypagestyle{plain}{
  \fancyhf{}
  \fancyfoot[C]{\textcolor{headerred}{\thepage}}
  \renewcommand{\headrulewidth}{0pt}
}
...
% Chapter title: Large bold number + italic title
...
% 3. QUESTION BOX - Teal header bar, light gray body (Q1, Q2, etc.)
...
\newtcolorbox{questionbox}{
  ...
  before upper={\refstepcounter{questioncount}},
  title={\textbf{Q\thequestioncount}},
  coltitle=white,
  colbacktitle=tealheader,
  fonttitle=\bfseries\sffamily
}

% 4. SOLUTION BOX - Charcoal border, white background (S1, S2, etc.)
\newcounter{solutioncount}
\newtcolorbox{solutionbox}{
  enhanced,
  breakable,
  colback=white,
  colframe=charcoalheader,
  boxrule=1pt,
  arc=0pt,
  left=12pt,
  right=12pt,
  top=12pt,
  bottom=12pt,
  before upper={\refstepcounter{solutioncount}\textbf{S\thesolutioncount}\par\vspace{6pt}}
}
